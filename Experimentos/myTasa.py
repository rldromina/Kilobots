...
#################### MUEVO EL ARCHIVO DE LA CAMARA ####################
#origen = '/home/romi/Escritorio/origen'
#destino = '/home/romi/Escritorio/destino'

origen = r'/run/user/1000/gvfs/mtp:host=Sony_E5606_YT911BA6SB/Almacenamiento interno/DCIM/OpenCamera/Kilobot'
destino = os.path.expanduser('~/Escritorio/Repositorios/Kilobots/Media')
...
def mover(origen,destino):
    ...
    if files == []:
        print('No hay videos en la carpeta de origen')
    else:
        for f in files:
...
def myTasa(file):
    ...
    radio = 150 
    step = int(input("Cuál es el step? "))# Tiempo mínimo de Kilobot girando (en milisegundos)
    left = int(input("Escriba la calibración left ")) # Calibración del Kilobot
    right = int(input("Escriba la calibración right ")) # Radio de la arena (en milímetros)

    #################### CREO LA CARPETA DE FRAMES ####################
    print('Creando carpeta de con los frames')
    ...
    print('Cargo el video y extraigo sus frames')
    ...
    print('Exportando los metadatos al csv')
    meta_dict = {
